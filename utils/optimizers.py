...
def get_optimizer(theta, config):
    ...
    optimizer_group_parameters.extend(get_params(theta, name="ner_prefix_encoder", lr=ner_lr*10))
    added_list.append("ner_prefix_encoder")

    optimizer_group_parameters.extend(get_params(theta, name="rel_prefix_encoder", lr=rel_lr*10))
